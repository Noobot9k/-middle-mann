...
///////////////////
	...
	"ConsoleButton"
	{
		...
		"brighttext"	"0"
		"default"		"1"
		"command"		"engine showconsole; clear; echo middle mann v23.1.1-beta; echo last updated: 30/03/25" //mostly used for bug reporting, remind self to update this string after every release
		"labeltext"		"Console"
		"sound_depressed"	"UI/buttonclick.wav"
		"sound_released"	"UI/buttonclickrelease.wav"
		"proportionaltoparent"	"1"
